...
As \citet[1]{Linzer2014} note, judicial independence is used as key covariate in many comparative studies such as studies of regime stability, economic growth, determining how judicial independence is fomented, and most prominently protection of human rights.  \citet{Keith2002b} draws the relationship between judicial independence and human rights protections quite clearly.  Despite the methodological differences that \citet{Rios2014} find in her measurement of judicial independence, Keith draws a clear line between judicial independence and protection of human rights. 
...
\citet{Rios2014} examine three distinct measures of \textit{de jure} judicial independence.  R\'{i}os-Figueroa and Staton examine three measures of \textit{de jure} judicial independence: Feld and Voigt \citeyearpar{Feld2003}, Keith \citeyearpar{Keith2002a} study and La Porta et al.\ \citeyearpar{Laporta2004}.  They also evaluate Apodaca's \citeyearpar{Apodaca2004} study.  Each of these studies develop a measure of \textit{de jure} judicial independence using different indicators and different methodologies.
...
\citet*{Melton2014} create an additive index that uses six aspects of judicial independence.  This model as well as that of \citet*{Feld2003} and \citet*{Keith2002b} use an additive index.  Table \ref{Indicators} shows previous studies of \textit{de jure} judicial independence and the indicators that were used.   

As \citet*{Linzer2014} show that a Bayesian IRT models can be more informative.   
